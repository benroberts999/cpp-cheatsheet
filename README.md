...
* There are also a few more advanced examples: lapack_basic, etc.
...
## Example Makefil project

In Makefile-Project, there is an axample project that compiles a bunch of source files using Make.
See that directory for info and instructions.
